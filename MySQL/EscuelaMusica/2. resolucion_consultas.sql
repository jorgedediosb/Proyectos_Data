...
-- Solución 2 (sin JOIN - JOIN implícito)
SELECT a.nombre, a.apellido
...
-- Listar el nombre y apellido de los alumnos junto con los nombres de los cursos en los que están inscritos,
-- pero solo para aquellos que se inscribieron en 2024.
SELECT a.nombre, a.apellido, c.nombre
FROM alumnos a
JOIN inscripciones i ON a.id_alumno= i.id_alumno
JOIN cursos c ON i.id_curso = c.id_curso
